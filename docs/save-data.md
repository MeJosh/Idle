...
Version `0.3.0` adds the generated hiring board, its next-arrival timestamp, the candidate sequence, and worker rarity. Workers retained from an older save migrate as Common.
